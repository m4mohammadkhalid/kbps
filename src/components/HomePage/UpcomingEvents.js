          ...
          <div className="container">
            ...
            <div className="row event_list justify-content-center">
              <div className="col-lg-6">
                <div
                  className="content_box event_box box_shadow1 animation mb-4 mb-lg-0"
                  data-animation="fadeInUp"
                ...
                >
                  ...
                  <div className="event_date">
                    ...
                    <span className="event_time bg_default">
                      10:00 am 3:00 pm
                    </span>
                  </div>
              ...
              <div className="col-lg-6">
                <div className="row">
                  <div className="col-md-12">
                    <div
                      className="content_box event_box box_shadow1 animation"
                      data-animation="fadeInUp"
